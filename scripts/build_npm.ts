...
await build({
  ...
  package: {
    ...
    description: "Universal Huobi API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/huobi.git",
    },
    bugs: {
      url: "https://github.com/coinset/huobi/issues",
    },
    homepage: "https://github.com/coinset/huobi#readme",
    funding: {
      type: "patreon",
